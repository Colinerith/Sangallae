...
object API {
    ...
    //aws key
    const val AWS_ACCESS_KEY: String = "비공개"
    const val AWS_SECRET_KEY: String = "비공개"
    ...
    //const val GPX_DIR: String = "/storage/emulated/0/gpxdata/" // 외부 저장소
    const val GPX_DIR: String = "gpxdata/"
